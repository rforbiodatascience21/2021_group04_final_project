...
### </b>
* Rstudio software was used to tidy and transform the flow cytometry raw data and to generate graphs to perform the T cell phenotype analysis. 
* Tidyverse package:
...
## Raw dataset
* Raw data obtained from flowcytometry analysis.
...
## COVID-19 raw dataset - Dataset 1 {.smaller}
```{r}
covid_data_raw
```
...
## Figure 1
Expression of cell surface markers in SARS-CoV-2 multimer+ T cells

```{r fig_A, fig_B, echo = FALSE, out.width = "900px", fig.align='center', out.height= "300px"}
...
## Figure 2
Expression of cell surface markers in CEF and SARS-CoV-2 multimer+ T cells
