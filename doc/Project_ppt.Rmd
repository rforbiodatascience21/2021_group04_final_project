...
* The project utilizes flow cytometry data to make a T cell phenotype analysis based on the expression change of cell-surface markers in COVID-19 patients compared to healthy individuals.
