...
* Rstudio was used to wrangle and augment the flow cytometry raw data and to generate graphs to perform T cell phenotype analysis. 
...
* Performed to clean and transform (wrangle) the data into a format which can be plotted. 
* Remove NA
