...
widescreen: true
smaller: true
logo:"/doc/DTU_Logo_Corporare_Red_CMYK.png"
---
...
## Figures D and E
```{r fig_D, echo = FALSE, out.width = "650px", out.height= "300px", fig.align='center'}
...
```{r fig_F, echo = FALSE, out.width = "1000px", fig.align='center'}
include_graphics("../results/04_fig_F.png")
```

## Figure G

```{r fig_G, echo = FALSE, out.width = "900px", fig.align='center'}
include_graphics("../results/04_fig_G.png")
```

## Figure H

```{r fig_H, echo = FALSE, out.width = "1000px", fig.align='center'}
include_graphics("../results/04_fig_H.png")
```
